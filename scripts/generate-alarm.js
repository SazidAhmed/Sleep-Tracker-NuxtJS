...
// Run from the project root with: node scripts/generate-alarm.js (requires Node.js)
// Output: public/alarm.mp3 (WAV format with .mp3 extension for browser compatibility)
